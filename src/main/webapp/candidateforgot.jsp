...
<head>
    ...
    <link rel="stylesheet" href="CSS/candidateforgotStyle.css">
    <title>Candidate forgot password Page</title>
...
<body class="body">
  <h1 class="h1"> <u>Reset Your Password</u></h1>
    <div class="wrapper">
      <form action="candidateforgotAction.jsp" method="post" name="f1" onsubmit="return myfun()">
        <div class="email"><br>
         <b> Email</b> &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
