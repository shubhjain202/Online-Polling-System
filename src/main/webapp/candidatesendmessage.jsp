...
<body bgcolor="black">
<form action="candidatesendmessage.jsp" method="post">
...
<%
	...
	{		
		...
		Connection con =  DriverManager.getConnection(url, uname, pass);
			String sql1="insert into userdb.candidate_message(candiadte_id,message) values('"+id+"','"+msg+"') on duplicate key update message='"+msg+"'";
			PreparedStatement pst1= con.prepareStatement(sql1);
			int j=pst1.executeUpdate();
			if(j>0)
			{
				response.sendRedirect("candidateafterqestion.jsp");
			}
			else
			{
